        ...
        <div class="row">
            <div class="col-md-12 col-sm-6 col-lg-3">
                <div class="card card-body shadow-sm border-0">
                    ...
                    <div>
                        <form action="{{ route('uploadProfilePhoto') }}" method="POST">
                            @csrf
                            <div class="mb-2">
                                <input name="photo" class="form-control form-control-sm" type="file" id="formFile">
                            </div>
            ...
            <div class="col-md-12 col-lg-9">
                <div class="card card-body shadow-sm border-0">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-education" role="tabpanel" aria-labelledby="pills-edu-tab"
                            tabindex="0">
